...
// --------------------------------------------------------------------------
// Singleton security context â€” lives for the app lifetime.
// --------------------------------------------------------------------------
...
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeInit(
...
JNIEXPORT void JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeDestroy(
...
// â”€â”€ Cookie management â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

JNIEXPORT void JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeSetCookie(
...
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeGetCookie(
...
JNIEXPORT void JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeParseCookies(
...
JNIEXPORT void JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeClearCookies(
        JNIEnv* /* env */, jobject /* thiz */) {
...
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeHasSession(
        JNIEnv* /* env */, jobject /* thiz */) {
...
JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeBuildCookieHeader(
        JNIEnv* env, jobject /* thiz */) {
    if (!g_cookieManager) return std2jstring(env, {});
...
JNIEXPORT void JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeStoreCsrfToken(
        JNIEnv* env, jobject /* thiz */, jstring token) {
    if (g_apiSecurity) g_apiSecurity->storeCsrfToken(jstring2std(env, token));
}

JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeGetCsrfToken(
        JNIEnv* env, jobject /* thiz */) {
    if (!g_apiSecurity) return std2jstring(env, {});
    return std2jstring(env, g_apiSecurity->getCsrfToken());
}

// â”€â”€ Header building â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

// Returns newline-separated "Key: Value" pairs.
JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeBuildAuthHeaders(
        JNIEnv* env, jobject /* thiz */) {
    if (!g_apiSecurity) return std2jstring(env, {});
...
// â”€â”€ Login / Signout body builders â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeBuildLoginBody(
        JNIEnv* env, jobject /* thiz */,
...
JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeBuildSignoutBody(
...
JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeMovieStreamUrl(
...
JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeMovieEmbedUrl(
        JNIEnv* env, jobject /* thiz */, jstring id) {
    if (!g_apiSecurity) return std2jstring(env, {});
...
JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeEpisodeStreamUrl(
        JNIEnv* env, jobject /* thiz */, jstring id) {
    if (!g_apiSecurity) return std2jstring(env, {});
...
JNIEXPORT jstring JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeEpisodeEmbedUrl(
        JNIEnv* env, jobject /* thiz */, jstring id) {
    if (!g_apiSecurity) return std2jstring(env, {});
...
JNIEXPORT jboolean JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeCheckStreamRateLimit(
        JNIEnv* /* env */, jobject /* thiz */) {
...
JNIEXPORT void JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeRecordStreamRequest(
        JNIEnv* /* env */, jobject /* thiz */) {
    if (g_apiSecurity) g_apiSecurity->recordStreamRequest();
}

// â”€â”€ Key rotation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

JNIEXPORT void JNICALL
Java_com_sarrows_app_data_ndk_NativeSecurity_nativeRotateKey(
